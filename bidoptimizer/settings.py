...
CSRF_TRUSTED_ORIGINS = [
    ...
    'http://192.168.5.114:8080',
    'https://tbbid.iepose.cn',
    'http://tbbid.iepose.cn',
    'http://127.0.0.1',
    'http://localhost',
]
...
ROOT_URLCONF = 'bidoptimizer.urls'
...
WSGI_APPLICATION = 'bidoptimizer.wsgi.application'
...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            'filename': os.path.join(BASE_DIR, 'log/app.log'),  # 使用相对路径
            'formatter': 'verbose',
        },
        'console': {
            'level': 'INFO',
